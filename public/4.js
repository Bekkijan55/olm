  ...
  methods: {
    storeEdu: function storeEdu() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          _this.$store.dispatch('addEdu', _this.edu).then(function () {
            _this.popup = false;
          });
        }
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(['fetchEdu']), {
    editEdu: function editEdu(val) {
      Object.assign(this.edus, val);
    },
    changeEdu: function changeEdu() {
      var _this = this;

      this.$store.dispatch('updateEdu', this.edus).then(function () {
        _this.popup = false;
      });
    }
  })
                ...
                _c("div", { staticClass: "vx-row" }, [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
                        _vm._v(_vm._s(_vm.errors.first("Таълим")))
                      ])
                    ],
                    1
                  )
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass: "holamundo",
          attrs: { title: "Update Education", active: _vm.popup },
          on: {
            "update:active": function($event) {
              _vm.popup = $event
            }
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.edus.edu_uz,
                          callback: function($$v) {
                            _vm.$set(_vm.edus, "edu_uz", $$v)
                          },
                          expression: "edus.edu_uz"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.edus.edu_uz2,
                          callback: function($$v) {
                            _vm.$set(_vm.edus, "edu_uz2", $$v)
                          },
                          expression: "edus.edu_uz2"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.edus.edu_ru,
                          callback: function($$v) {
                            _vm.$set(_vm.edus, "edu_ru", $$v)
                          },
                          expression: "edus.edu_ru"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
