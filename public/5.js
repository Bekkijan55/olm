...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    storeParty: function storeParty() {
      ...
      this.$store.dispatch('addParty', this.party).then(function () {
        _this.popup = false;
      });
    }
  }
                    ...
                    return _vm._l(data, function(val) {
                      return _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("vs-td", [_vm._v(_vm._s(val.party_en))]),
                          _vm._v(" "),
                          _c(
                            "vs-td",
                            [
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.party.party_en,
                          callback: function($$v) {
                            _vm.$set(_vm.party, "party_en", $$v)
                          },
                          expression: "party.party_en"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
