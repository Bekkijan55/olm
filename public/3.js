...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    storeInst: function storeInst() {
      ...
      this.$store.dispatch('addInst', this.inst).then(function () {
        _this.popup = false;
      });
    }
  }
                    ...
                    return _vm._l(data, function(val) {
                      return _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("vs-td", [_vm._v(_vm._s(val.inst_en))]),
                          _vm._v(" "),
                          _c(
                            "vs-td",
                            [
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.inst.inst_uz,
                          callback: function($$v) {
                            _vm.$set(_vm.inst, "inst_uz", $$v)
                          },
                          expression: "inst.inst_uz"
                        }
                      }),
                      _vm._v(" "),
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.inst.inst_ru,
                          callback: function($$v) {
                            _vm.$set(_vm.inst, "inst_ru", $$v)
                          },
                          expression: "inst.inst_ru"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("vs-input", {
                        ...
                        model: {
                          value: _vm.inst.inst_en,
                          callback: function($$v) {
                            _vm.$set(_vm.inst, "inst_en", $$v)
                          },
                          expression: "inst.inst_en"
                        }
                      }),
                      _vm._v(" "),
                      _c("span", { staticClass: "text-danger text-sm" }, [
